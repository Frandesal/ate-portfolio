    ...
    <section id="contact" style={{ padding: 'var(--section-padding)', background: 'var(--bg-surface)' }}>
      <div className="container grid-2" style={{ alignItems: 'center' }}>
        ...
        <motion.div
           ...
           viewport={{ once: true }}
        >
          <h2 className="font-display hero-title" style={{ fontSize: '3.5rem', marginBottom: '32px', color: 'var(--charcoal)' }}>Let's Work<br/>Together.</h2>
          <p style={{ color: 'var(--text-muted)', marginBottom: '64px', fontSize: '1.2rem', maxWidth: '400px' }}>
            Ready to take your business to the next level? Send a message and let's get started.
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            <motion.div whileHover={{ x: 10 }} style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', cursor: 'pointer' }}>
          ...
          >
            <a 
              ...
              download
              className="btn-ghost"
              style={{ paddingLeft: 0, background: 'var(--bg-surface-low)', padding: '16px 32px' }}
            >
